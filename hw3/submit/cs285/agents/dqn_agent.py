...
#              'eps', eps)
        ...
        if perform_random_action:
            ...
            # Get most recent frame_history_len observations
            history = self.replay_buffer.encode_recent_observation()
            action = self.actor.get_action(history)
